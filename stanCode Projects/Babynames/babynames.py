...
This file takes government's data of baby name rank of each year
...
def add_file(name_data, filename):
    ...
    with open(filename) as f:
        name_lst = []
        for line in f:
            # make each line a list, ie. ['1', 'Jacob', 'Emily'] and store it into name_lst
            name_lst.append(line.split(','))
        for ranked_n in name_lst[1:]:
            for name in ranked_n[1:]:
                add_data_for_name(name_data, name_lst[0][0].strip(), ranked_n[0].strip(), name.strip())
